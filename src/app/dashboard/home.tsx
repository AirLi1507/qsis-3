  ...
  return (
    <>
      ...
      <div className="h-fit mt-4 flex flex-col md:grid md:grid-cols-2 gap-4 px-2 pb-4">
        ...
        <Tab href="homework" icon={IconFilePencil} title={t("tab_name.homework")} description={t("home.homework_desc")} />
        <Tab href="ec" icon={IconBallBasketball} title={t("tab_name.ec")} description={t("home.ec_desc")} />
        <Tab href="reading" icon={IconBooks} title={t("tab_name.reading")} description={t("home.reading_desc")} />
        <Tab href="ss" icon={IconCheckbox} title={t("tab_name.ss")} description={t("home.ss_desc")} />
      </div>
    </>
  )
}
