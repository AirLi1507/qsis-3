...
interface TextboxProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, "type"> {
  Icon?: Icon
...
const Textbox = ({ Icon, type, ref, ...props }: TextboxProps) => {
  ...
  return (
    <div className="text-sky-900/75 text-lg w-full bg-sky-50/55 hover:bg-sky-50/75 focus-within:bg-sky-50/75 border-2 border-sky-50/25 rounded-md inset-shadow-[0_0_4px_rgba(0,0,0,.25)] flex p-1 duration-100">
      {
        Icon
        &&
